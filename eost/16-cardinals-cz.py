...
class Chapter16OpeningTitle(OpeningTitle):
    CONFIG = {
        ...
        "chapter_str" : "Kapitola 16\\\\ Kardinální čísla",
    }
...
class ContinuumSquare(Scene):
    def construct(self):
        ...
        self.dither()
        for seq in sequences: self.play(ShowCreation(seq))
        self.dither()
        self.play(
...
class MagicSetConstruction(MagicSetScene):
    ...
    def bar_to_circle(self, bar, circle):
        bar_c = bar[0].copy()
        self.play(
...
class CardinalSquare(Scene):
    def construct(self):
        ...
        for i,bar in enumerate(card_bars):
            ...
            animations = [Transform(bar, card_bar_template),]
            if i < 3:
...
class Takeovers(Scene):
    ...
    def play_basic_infinity(self):
        ...
        self.play(Write(VGroup(cardinals[1:])))
        self.dither()
        omega1 = Omega1()
