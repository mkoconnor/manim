...
class NaturalsDefinition(Scene):
    def construct(self):
        ...
        self.dither()
        self.play(FocusOn2(naturals[0]))
        self.play(FocusOn2(naturals[1]))
...
class ConstructionOmega(Scene):
    def construct(self):
        ...
        self.play(FadeIn(es_copy))
        self.play(ReplacementTransform(empty_set.copy(), set_1))
        self.dither()
