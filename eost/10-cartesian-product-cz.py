...
class FunctionsAtoB(Scene):
    def construct(self):
        ...
        self.play(*map(FadeIn, [
            a_rect, a_label, b_rect, b_label, elements_a, elements_b,
        ]))
        ...
        self.play(FadeIn(matching_note))
...
class GraphMatching(Scene):
    def construct(self):
        ...
        for bundle in compl_graph:
            self.play(bundle.highlight, YELLOW, run_time = 0.5)
            self.dither(0.5)
            self.play(bundle.highlight, GREY, run_time = 0.5)
...
class ConstructionOverview(Scene):
    def construct(self):
        ...
        axioms = variants[0]
        self.play(FadeIn(axioms[0], submobject_mode = "lagged_start"))
        self.play(FadeIn(axioms[1], submobject_mode = "lagged_start"))
        self.play(FadeIn(axioms[2], submobject_mode = "lagged_start"))
        self.dither()
