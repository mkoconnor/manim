...
class Chapter1OpeningQuote(OpeningQuote):
    CONFIG = {
        "quote" : [
            "Teorie množin má v matematice dvojí roli. V čisté matematice se jedná o studium otázek týkajících se nekonečna. I když jde o fascinující téma, nevysvětluje to důležitost teorie množin v aplikovaných oborech. Ta spočívá ve faktu, že teorie množin poskytuje neuvěřitelně všestranné nástroje pro budování matematických modelů rozličných vlastností."
        ],
...
class CantorScene(Scene):
    ...
    def construct(self):
        ...
        title = TextMobject("Teorie","množin")
        title.scale(1.3)
        title.to_edge(UP)
        self.add(title)
        self.wait_to(14.5)
        outside_shortcut = VGroup(*title[0][2:] + title[1][3:])
        self.play(outside_shortcut.highlight, DARK_GREY)
        ...
        self.wait_to(21)
        studies0 = TextMobject("Studium","nekonečna")
        ...
        studies1 = TextMobject("Studium","nekonečných","množin")
        studies1.scale(1.3)
        studies1.move_to(studies0)
        studies1[1].highlight(YELLOW)

        sets_ori = title[1].copy()
        s = studies1[-1][-1].copy()
        ...
        self.play(FadeOut(cantor),
                  FadeOut(cantor_desc),
                  studies1.next_to, title, DOWN,
                  outside_shortcut.highlight, WHITE
        )
...
class HotelScene(Scene):
    ...
    def construct(self):
        ...
        title.scale(1.3)
        title.to_edge(UP)
        subtitle = TextMobject("Studium","nekonečných","množin")
...
class TwoSetTheoryRoles(Scene):
    ...
    def construct(self):
        ...
        title = TextMobject("Teorie množin").scale(1.3).to_edge(UP)
        ...
        theory_of_infinity = TextMobject("Teorie nekonečna").highlight(BLUE)
        foundations_of_mathematics = TextMobject("Základy matematiky",
...
class ChapterList(Scene):
    ...
    def construct(self):
        ...
        brace = BraceText(series[:7], "Teorie nekonečna")
        self.play(brace.creation_anim())

        self.wait_to(5.5)
        self.play(brace.change_brace_desc, series[7:14], "Základy matematiky")

        brace_dest = brace.copy()
        brace_dest.change_brace_desc(series[14:16], "Nástroje")
...
class InfinityBasics(Scene):
    ...
    def construct(self):
        ...
        question = TextMobject("Co je nekonečn","o","?", arg_separator='')
        question.scale(1.3)
        question.to_edge(UP)
        ...
        question2 = TextMobject("Co je nekonečn","é","?", arg_separator='')
        question2.scale(1.3)
        ...
        answer = TextMobject("To, co není","konečné").scale(1.3)
        ...
        finite_def = BraceText(answer[-1], "možné vyjádřit\\\\ přirozeným číslem")
        self.wait_to(32.5)
        ...
        self.wait_to(37)
        self.play(FadeIn(set5), brace5.creation_anim()) # 38
        self.play(brace5.change_desc, "konečná") # 39
        self.dither() # 40
        self.remove(brace5)
        #self.play(FadeOut(brace5)) # 41
        ...
        self.play(brace100.change_desc, "konečná") # 42
        self.dither() # 43
        self.play(FadeOut(VGroup(brace100, set100))) # 44
        ...
        brace_inf = BraceText(set_inf, "nekonečná", UP, desc_scale = 1.3)
        self.play(FadeIn(set_inf), GrowFromCenter(brace_inf.brace)) # 45
        self.dither()
        ...
        brace0 = BraceText(set0, "konečná", UP)
        self.play(ReplacementTransform(rect_inf, set0)) # 53.5
        self.play(brace0.creation_anim()) # 54.5
        self.wait_to(57.5)
        self.play(brace0.change_desc, '0')

        self.wait_to(71.5)
        self.play(FadeOut(VGroup(set0, brace0, answer, finite_def)), ReplacementTransform(question2, question1)) # 72.5
        self.dither()
        self.play(Write(TextMobject("Ne jen velké číslo...")))
        self.wait_to(90.5)
...
class FinGridColoring(Scene):
    ...
    def construct(self):
        ...
        self.play(ShowCreation(border)) # 1
        self.play(ShowCreation(lines, submobject_mode = "lagged_start", run_time = 1.5)) # 2.5
