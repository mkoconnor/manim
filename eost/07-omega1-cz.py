...
class Chapter7OpeningTitle(OpeningTitle):
    CONFIG = {
        ...
        "chapter_str" : "Kapitola 7\\\\ Omega 1",
    }
...
chapter5 = importlib.import_module('eost.05-ordinals-cz')
...
class CardinalsOrdinalsRecap(chapter2.NotationScene):
    def construct(self):
        ...
        self.overall_picture.next_to(self.subtitle, DOWN, buff = 0.5, coor_mask = Y_MASK)
...
class SupremumRecap(chapter5.OrdinalByRecursion):
    def construct(self):
        ...
        self.wait_to(23)
        self.play(FadeOut(supremum, title))
...
class Supremum(Scene):
    def construct(self, fast_play = False):
        ...
        conversation.add_bubble("Ale podle kapitoly 5 si nemůžeme vzít všechny ordinály.")
        self.wait_to(29.5)
...
class ContinuumHypothesis(Scene):
    def construct(self):
        ...
        question = TextMobject("Je $|\mathbb R|$ nejmenší nespočetná mohutnost?")
        question.shift(DOWN)
...
class UnboundedOmega(LeastInfinite):
    def construct(self):
        ...
        unbounded = TextMobject("neomezená")
        ...
        self.subset = subset
        self.brace = None
        self.show_terminal_brace(-2) # 19.5
        self.dither()
        self.show_terminal_brace(0) # 21.5
        self.dither()
        self.show_terminal_brace(2) # 23.5
        self.dither()
...
class IntervalMul(Scene):
    def construct(self):
        ...
        conversation = Conversation(self)
        conversation.add_bubble("Neměl by být výsledek delší než první činitel?")
...
class LongLine(Scene):
    def construct(self):
        ...
        self.wait_to(6.5)
        title = TextMobject("Dlouhá přímka").to_edge(UP)
        ...
        self.brace = None
        self.show_initial_brace(-1.5) # 13.5
        self.dither()
        self.show_initial_brace(2.5) # 15.5
        self.dither()
        self.show_initial_brace(4.5) # 17.5
        self.dither() # 18.5
...
class NextChapter(Scene):
    def construct(self):
        ...
        self.dither()
        conversation.add_bubble("A co množina všech množin, které neobsahují samy sebe?")
        self.dither(2)
